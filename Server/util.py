...
def get_b64_test_image_for_robert():
    with open("./Server/b64_2.txt") as f:
        return f.read()
    
if __name__ == '__main__': 
    load_saved_artifacts()
    print(classify_image(get_b64_test_image_for_robert(), None))
    print("\n")
    print(classify_image(None, "./Server/test_images/001_08212dcd.jpg"))
    print("\n")
    print(classify_image(None, "./Server/test_images/025_cd625bef.jpg"))
    print("\n")
    print(classify_image(None, "./Server/test_images/035_8e23d941.jpg"))
